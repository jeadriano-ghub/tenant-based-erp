  ...
  return (
    <>
      ...
      <div>
        ...
        <select name="parentId" defaultValue={defaultValueParent ?? ""} className={controlClass}>
        ...
        <div className="mb-2 flex items-center justify-between">
          <div>
            ...
            <p className="text-xs text-[var(--muted)]">
              Define fields (e.g. size, color, wattage) shown when creating a product in this category. Drag the handle to reorder.
            </p>
          </div>
          <button
            type="button"
