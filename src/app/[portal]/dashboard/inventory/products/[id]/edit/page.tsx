...
const PRODUCT_TYPE_OPTIONS = ["SERIALIZED", "NON_SERIALIZED", "BARCODE"];
      ...
      <Card>
        <ActionForm action={saveProductAction} portal={slug} submitLabel="Save changes" redirectOnSuccess={`${base}/dashboard/inventory/products`}>
          ...
          <FormSection title="Product" description="Core item master data.">
            ...
            <Select label="Type" name="productType" required options={PRODUCT_TYPE_OPTIONS} defaultValue={product.productType} />
            <Field label="Unit of measure" name="unitOfMeasure" placeholder="pc" defaultValue={product.unitOfMeasure || "pc"} />
            <div>
              <label className="block text-xs font-medium text-[var(--muted)]">Cost price</label>
            ...
            <div>
              <label className="block text-xs font-medium text-[var(--muted)]">Selling price</label>
            ...
            <Field label="Min stock level" name="minStockLevel" defaultValue={product.minStockLevel != null ? String(product.minStockLevel) : ""} />
            <Field label="Reorder point" name="reorderPoint" defaultValue={product.reorderPoint != null ? String(product.reorderPoint) : ""} />
            <div>
              <label className="block text-xs font-medium text-[var(--muted)]">Category</label>
            ...
            <div>
              <label className="block text-xs font-medium text-[var(--muted)]">Brand</label>
